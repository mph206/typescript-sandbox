 ...
 */
export const replaceColours = (colours: string[]): string[] => {
    let newColours: string[] = [...colours];
  ...
  */
  export const palindromeChecker = (word: string): boolean => {
  ...
  */
  export const getAllPalindromes = (words: string[]): string[] => {
