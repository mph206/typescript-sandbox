 ...
 */
export const findLargerOfTwoNumbers = (num1: number, num2: number): number => {
 ...
 */
export const findSmallestOfThreeNumbers = (num1: number, num2: number, num3: number): number => {
 ...
 * @return {string} grade - The relevant grade for the score e.g. A
 */
export const generateReportCardGreeting = (name: string, score: number): string => {
  let greeting: string = "";
  let grade: string = calculateGrade(score);
  switch (grade) {
    case "D":
