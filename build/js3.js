...
exports.generateReportCardGreeting = exports.calculateGrade = exports.findSmallestOfThreeNumbers = exports.findLargerOfTwoNumbers = void 0;
/**
 * A function that takes two numbers and returns the largest of the two numbers
 *
 * @return {number} largest number - e.g. 10
 */
exports.findLargerOfTwoNumbers = function (num1, num2) {
    if (num1 >= num2)
        return num1;
    return num2;
};
 ...
 */
exports.findSmallestOfThreeNumbers = function (num1, num2, num3) {
 ...
 */
exports.calculateGrade = function (score) {
 ...
 * @return {string} grade - The relevant grade for the score e.g. A
 */
exports.generateReportCardGreeting = function (name, score) {
    var greeting = "";
    var grade = exports.calculateGrade(score);
    switch (grade) {
        case "D":
